...
export default function NewItem({onAddItem}){
    ...
    const [id, setID] = useState(generateRandomString(18)); // Initialize a random string for id
    ...
    return(
        ...
        <div className="flex flex-col items-center justify-start space-y-6 p-10 bg-gray-200 h-screen"> 
            ...
            <form className="bg-white shadow-lg rounded-lg p-6 w-full max-w-md space-y-6" 
                ...
                {/* const randomString = generateRandomString(18);  //Generates a random string of characters */}
                
                {/* Item ID */}
                <div className="flex flex-col space-y-2">
                <label htmlFor="id" className="font-medium text-gray-700">ID</label>
                <input
                    id="id"
                    type="text"
